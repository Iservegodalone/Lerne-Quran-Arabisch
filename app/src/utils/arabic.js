...
export const TASHKIL_REGEX_SOURCE = '[\\u064B-\\u0652\\u0657\\u0656]'
...
/**
 * Get word at a specific character index in text.
 *
 * @param {string} text - Full text.
 * @param {number} charIndex - Character index within the text.
 * @returns {{word: string, start: number, end: number, wordIndex: number} | null}
 */
