...
const ROLES = [
  'Mubtada', 'Khabar', "Fa'il", "Maf'ul bihi", 'Majrur', 'Mudaf', 'Mudaf ilayhi',
  'Sifa/Na\'t', 'Badal', 'Hal', 'Tamyiz', 'Munada', "Na'ib al-Fa'il",
  'Harf (Partikel)', "Fi'l (Verb)", 'Zarf', "Maf'ul mutlaq", "'Atf (Koordination)",
  'Ism inna', 'Khabar inna', 'Ism kana', 'Khabar kana', 'Jawab shart',
  "Maf'ul li-Ajlihi", "Maf'ul Ma'ahu", 'Zarf Zaman', 'Zarf Makan',
  'Mustathna (Ausgenommenes)'
]
...
const INLINE_EXERCISES = [
  ...
  },
  {
    ...
    words: [
      { word: '\u0625\u0650\u064A\u0651\u064E\u0627\u0643\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Vorangestelltes Objekt (Taqdim). Emphatische Akkusativform des Pronomens 2ms' },
      ...
      { word: '\u0648\u064E\u0625\u0650\u064A\u0651\u064E\u0627\u0643\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: '\u0648\u064E (Konjunktion) + vorangestelltes Objekt. Parallele Struktur zum ersten Halbvers' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0644\u0635\u0651\u0650\u0631\u064E\u0627\u0637\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt von \u0627\u0647\u0652\u062F\u0650. Fatha als Kasuszeichen' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0631\u064E\u0628\u0651\u064E\u0643\u064F\u0645\u064F', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt. Fatha + Possessivsuffix \u0643\u064F\u0645\u064F' }
    ]
  },
  {
    ref: '112:1',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0644\u0644\u0651\u064E\u0647\u064F', role: "Fa'il", case: 'Nominativ (Raf\')', explanation: 'Subjekt des Verbs. Damma' },
      { word: '\u0623\u064E\u0646\u0651\u064E\u0647\u064F', role: "Maf'ul bihi", case: 'Indeklinabel', explanation: '\u0623\u064E\u0646\u0651\u064E + Pronominalsuffix. Masdar-Satz als Objekt des Bezeugens' },
  ...
  // === NEUE ÜBUNGEN: Maf'ul mutlaq (absoluter Akkusativ) ===
  {
    ref: '4:164',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0644\u064E\u064A\u0652\u0644\u064B\u0627', role: 'Zarf Zaman', case: 'Akkusativ (Nasb)', explanation: 'Zeitadverbial (Zarf zaman). Akkusativ mit Tanwin-Fatha' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0628\u0652\u062A\u0650\u063A\u064E\u0627\u0621\u064E', role: "Maf'ul li-Ajlihi", case: 'Akkusativ (Nasb)', explanation: 'Akkusativ des Grundes: um das Wohlgefallen zu suchen. Fatha (Mudaf)' },
      { word: '\u0645\u064E\u0631\u0652\u0636\u064E\u0627\u062A\u0650 \u0627\u0644\u0644\u0651\u064E\u0647\u0650', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Idafa. \u0627\u0644\u0644\u0651\u064E\u0647\u0650 im Genitiv' }
    ]
  },
  {
    ref: '28:20',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0623\u064E\u0645\u0652\u0648\u064E\u0627\u0644\u064E\u0647\u064F\u0645\u064F', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt. Fatha + Possessivsuffix' },
      { word: '\u0627\u0628\u0652\u062A\u0650\u063A\u064E\u0627\u0621\u064E', role: "Maf'ul li-Ajlihi", case: 'Akkusativ (Nasb)', explanation: 'Akkusativ des Grundes. Masdar VIII. Um das Wohlgefallen zu suchen' },
      { word: '\u0645\u064E\u0631\u0652\u0636\u064E\u0627\u062A\u0650 \u0627\u0644\u0644\u0651\u064E\u0647\u0650', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Idafa-Konstruktion. Genitiv' }
    ]
  },
  {
    ref: '5:2',
    ...
    words: [
      ...
      { word: '\u0634\u064E\u0646\u064E\u0622\u0646\u064F', role: "Fa'il", case: 'Nominativ (Raf\')', explanation: 'Subjekt des Verbs. Damma (Mudaf)' },
      { word: '\u0642\u064E\u0648\u0652\u0645\u064D', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Zweites Glied der Idafa. Kasra mit Tanwin' }
    ]
  },
  {
    ref: '4:77',
  ...
  // === NEUE ÜBUNGEN: Zarf (Zeit-/Ortsadverbial) ===
  {
    ref: '2:274',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0644\u0650\u062F\u064F\u0644\u064F\u0648\u0643\u0650', role: 'Zarf Zaman', case: 'Genitiv (Jarr)', explanation: 'Zeitadverbial mit \u0644\u0650\u0640: beim Neigen. Genitiv (Idafa mit \u0627\u0644\u0634\u0651\u064E\u0645\u0652\u0633)' },
      { word: '\u0627\u0644\u0634\u0651\u064E\u0645\u0652\u0633\u0650', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Zweites Glied der Idafa. Kasra' }
    ]
  },
  {
    ref: '19:62',
  ...
  },
  {
    ...
    words: [
      { word: '\u0625\u0650\u0630\u0652', role: 'Zarf Zaman', case: 'Indeklinabel', explanation: 'Zeitpartikel: als/wenn. Indeklinabel, syntaktisch Akkusativ (Zarf)' },
      { word: '\u062C\u064E\u0627\u0621\u064F\u0648\u0643\u064F\u0645', role: "Fi'l (Verb)", case: 'Indeklinabel', explanation: 'Perfekt 3mp + Suffix \u0643\u064F\u0645 als Objekt' },
      { word: '\u0645\u0650\u0646 \u0641\u064E\u0648\u0652\u0642\u0650\u0643\u064F\u0645\u0652', role: 'Zarf Makan', case: 'Genitiv (Jarr)', explanation: 'Ortsangabe: von oberhalb von euch. \u0641\u064E\u0648\u0652\u0642 ist Zarf makan im Genitiv nach \u0645\u0650\u0646' }
    ]
  },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0647\u064E\u0670\u0630\u064E\u0627', role: "Maf'ul bihi", case: 'Indeklinabel', explanation: 'Demonstrativpronomen als erstes Objekt. Indeklinabel' },
      { word: '\u0627\u0644\u0652\u0628\u064E\u0644\u064E\u062F\u064E', role: 'Badal', case: 'Akkusativ (Nasb)', explanation: 'Badal (Apposition) zu \u0647\u064E\u0670\u0630\u064E\u0627. Fatha als Akkusativzeichen' },
      { word: '\u0622\u0645\u0650\u0646\u064B\u0627', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Zweites Objekt von \u0627\u062C\u0652\u0639\u064E\u0644\u0652 (doppelter Akkusativ). Tanwin-Fatha' }
    ]
  },
  {
    ref: '2:37',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0644\u0631\u0651\u064E\u0633\u064F\u0648\u0644\u064F', role: "Fa'il", case: 'Nominativ (Raf\')', explanation: 'Subjekt. Damma als Kasuszeichen' },
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0644\u0652\u0645\u064E\u0627\u0644\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt von \u0622\u062A\u064E\u0649. Fatha' }
    ]
  },
  {
    ref: '2:136',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0628\u064E\u064A\u0652\u0646\u064E', role: 'Zarf Makan', case: 'Akkusativ (Nasb)', explanation: 'Zarf makan im Akkusativ' },
      { word: '\u0623\u064E\u062D\u064E\u062F\u064D', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Idafa. Kasra mit Tanwin' },
  ...
  // === NEUE ÜBUNGEN: Munada (Vokativ) ===
  {
    ...
    words: [
      { word: '\u064A\u064E\u0627', role: 'Harf (Partikel)', case: 'Indeklinabel', explanation: 'Vokativpartikel' },
      { word: '\u0642\u064E\u0648\u0652\u0645\u0650', role: 'Munada', case: 'Akkusativ (Nasb)', explanation: 'Munada Mudaf — Akkusativ. Kasra hier wegen Idafa mit \u064A\u0627\u0621 al-Mutakallim (mein Volk)' },
      { word: '\u0627\u0639\u0652\u0628\u064F\u062F\u064F\u0648\u0627', role: "Fi'l (Verb)", case: 'Indeklinabel', explanation: 'Imperativ 2mp' },
      { word: '\u0627\u0644\u0644\u0651\u064E\u0647\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt. Fatha' }
    ]
  },
  {
    ref: '12:29',
  ...
  },
  {
    ...
    words: [
      { word: '\u064A\u064E\u0627', role: 'Harf (Partikel)', case: 'Indeklinabel', explanation: 'Vokativpartikel' },
      { word: '\u0642\u064E\u0648\u0652\u0645\u0650', role: 'Munada', case: 'Akkusativ (Nasb)', explanation: 'Munada Mudaf — Akkusativ (mit Kasra wegen Idafa mit \u064A\u0627\u0621 al-Mutakallim)' },
      { word: '\u0627\u062A\u0651\u064E\u0628\u0650\u0639\u064F\u0648\u0627', role: "Fi'l (Verb)", case: 'Indeklinabel', explanation: 'Imperativ 2mp, Form VIII, Wurzel \u062A-\u0628-\u0639' },
      { word: '\u0627\u0644\u0652\u0645\u064F\u0631\u0652\u0633\u064E\u0644\u0650\u064A\u0646\u064E', role: "Maf'ul bihi", case: 'Akkusativ (Nasb)', explanation: 'Direktes Objekt. -\u064A\u0646\u064E als Akkusativzeichen (gesunder mask. Plural)' }
    ]
  },
  {
    ref: '5:116',
  ...
  },
  {
    ...
    words: [
      ...
      { word: '\u0627\u0644\u0644\u0651\u064E\u0647\u0650', role: 'Mudaf ilayhi', case: 'Genitiv (Jarr)', explanation: 'Idafa-Konstruktion. Kasra' },
      { word: '\u0645\u064E\u062C\u0652\u0631\u064E\u0627\u0647\u064E\u0627', role: 'Zarf', case: 'Akkusativ (Nasb)', explanation: 'Zarf (Umstandsangabe): ihr Fahren/Laufen. Akkusativ (Fatha + Suffix)' },
      { word: '\u0648\u064E\u0645\u064F\u0631\u0652\u0633\u064E\u0627\u0647\u064E\u0627', role: "'Atf (Koordination)", case: 'Akkusativ (Nasb)', explanation: '\u0648\u064E + Atf auf \u0645\u064E\u062C\u0652\u0631\u064E\u0627\u0647\u064E\u0627. Koordiniert im Akkusativ' }
    ]
  },
  // === NEUE ÜBUNGEN: Na'ib al-Fa'il (Passivsubjekt) ===
  {
    ref: '2:87',
