...
const INLINE_EXERCISES = [
  { consonantal: '\u0643\u062A\u0628', context: 'Nach dem Subjekt \u0627\u0644\u0644\u0651\u064E\u0647\u064F in einem Verbalsatz', ref: '2:187', options: [
    ...
    { vocalized: '\u0643\u064F\u062A\u064F\u0628', analysis: 'kutub — Plural von \u0643\u0650\u062A\u064E\u0627\u0628: Buecher', correct: false }
  ...
  { consonantal: '\u062D\u0633\u0628', context: 'Vor einem Akkusativ-Pronomen und Khabar-Komplement', ref: '2:214', options: [
    ...
    { vocalized: '\u062D\u064E\u0633\u0652\u0628', analysis: 'hasb — Nomen: genuegend/Genuege', correct: false },
  ...
  ], explanation: 'Form II (\u0642\u064E\u062F\u0651\u064E\u0631\u064E) mit Shadda zeigt Intensivierung an. \u0648\u064E\u0627\u0644\u0652\u0642\u064E\u0645\u064E\u0631\u064E \u0642\u064E\u062F\u0651\u064E\u0631\u0652\u0646\u064E\u0627\u0647\u064F: Das Suffix \u0646\u064E\u0627\u0647\u064F (wir + ihn) bestaetigt die transitive Form II.' },
  { consonantal: '\u0627\u0645\u0631', context: 'Nach Praeposition \u0628\u0650 in einem Imperativsatz', ref: '7:29', options: [
  ...
  ], explanation: 'Nach einer Praeposition (\u0628\u0650) muss ein Nomen im Genitiv folgen, kein Verb. \u0623\u064E\u0645\u064E\u0631\u064E \u0631\u064E\u0628\u0651\u0650\u064A \u0628\u0650\u0627\u0644\u0652\u0642\u0650\u0633\u0652\u0637\u0650 — aber hier: \u0642\u064F\u0644\u0652 \u0623\u064E\u0645\u064E\u0631\u064E \u0631\u064E\u0628\u0651\u0650\u064A \u0628\u0650\u0627\u0644\u0652\u0642\u0650\u0633\u0652\u0637\u0650 zeigt \u0623\u064E\u0645\u064E\u0631\u064E als Verb mit \u0628\u0650 als Teil der Rektion.' },
  { consonantal: '\u0639\u0628\u062F', context: 'Als Objekt von \u0625\u0650\u064A\u0651\u064E\u0627\u0643\u064E \u0646\u064E...\u064F in 1:5', ref: '1:5', options: [
    ...
    { vocalized: '\u0646\u064E\u0639\u0652\u0628\u064F\u062F\u064E', analysis: 'na\u2018buda — Imperfekt 1pl Aktiv Subjunktiv: wir dienen (nach Subjunktiv-Ausloeser)', correct: false },
    { vocalized: '\u0646\u064F\u0639\u0652\u0628\u064E\u062F\u064F', analysis: 'nu\u2018badu — Imperfekt 1pl Passiv: uns wird gedient', correct: false }
  ], explanation: '\u0646\u064E\u0639\u0652\u0628\u064F\u062F\u064F mit Damma am Ende = Indikativ. Kein Subjunktiv-Ausloeser vorhanden (kein \u0623\u064E\u0646\u0652, \u0644\u064E\u0646\u0652, etc.). Aktiv weil \u0625\u0650\u064A\u0651\u064E\u0627\u0643\u064E (Akkusativ-Objekt) vorangestellt ist.' },
  { consonantal: '\u0647\u062F\u064A', context: 'Am Anfang von 2:2 nach \u0641\u0650\u064A\u0647\u0650', ref: '2:2', options: [
    { vocalized: '\u0647\u064F\u062F\u064B\u0649', analysis: 'hudan — Nomen (Masdar): Fuehrung (Akkusativ oder Nominativ mit Tanwin)', correct: true },
  ...
  { consonantal: '\u0636\u0644', context: 'Mit Praefix \u064A\u064F und Suffix \u0651\u064F in einem Kausativsatz', ref: '14:4', options: [
    { vocalized: '\u064A\u064F\u0636\u0650\u0644\u0651\u064F', analysis: 'yudillu — Imperfekt 3ms Form IV Aktiv: er fuehrt in die Irre', correct: true },
    { vocalized: '\u064A\u064E\u0636\u0650\u0644\u0651\u064F', analysis: 'yadillu — Imperfekt 3ms Form I: er irrt (selbst)', correct: false }
  ], explanation: 'Praefix \u064A\u064F (Damma) signalisiert Form IV (kausativ): \u064A\u064F\u0636\u0650\u0644\u0651\u064F = er LAESST in die Irre gehen. Praefix \u064A\u064E (Fatha) waere Form I: er GEHT selbst in die Irre. Im Konsonantentext identisch!' }
]
...
export default function ContextDisambiguationExercise() {
  ...
  function check() {
    ...
    setRevealed(true)
    setScore(s => ({ correct: s.correct + (ex.options[selected].correct ? 1 : 0), total: s.total + 1 }))
  }
          ...
          {ex.options.map((opt, i) => (
            <button key={i} onClick={() => !revealed && setSelected(i)}
              style={{
                ...
                background: revealed ? (opt.correct ? 'rgba(34,197,94,0.15)' : selected === i ? 'rgba(239,68,68,0.15)' : 'var(--bg)') : (selected === i ? 'rgba(45,212,191,0.1)' : 'var(--bg)'),
                color: 'var(--text)'
              }}>
