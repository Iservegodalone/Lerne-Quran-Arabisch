...
const EXERCISES = [
  ...
  { word: '\u0623\u064E\u064A\u0652\u062F\u0650\u064A\u0643\u064F\u0645\u0652', suffix: '\u0643\u064F\u0645\u0652', person: '2mp', function: 'Possessiv am Nomen', base: '\u0623\u064E\u064A\u0652\u062F\u0650\u064A (Haende)', ref: '5:11', explanation: 'Suffix \u0643\u064F\u0645\u0652 (eure) als Besitzer. Eure Haende.' },
  ...
  // An Praeposition
  { word: '\u0639\u064E\u0644\u064E\u064A\u0652\u0647\u0650\u0645\u0652', suffix: '\u0647\u0650\u0645\u0652', person: '3mp', function: 'Komplement der Praeposition', base: '\u0639\u064E\u0644\u064E\u0649 (auf/ueber)', ref: '1:7', explanation: 'Suffix \u0647\u0650\u0645\u0652 als Komplement der Praeposition. Auf ihnen.' },
  { word: '\u0644\u064E\u0643\u064F\u0645\u0652', suffix: '\u0643\u064F\u0645\u0652', person: '2mp', function: 'Komplement der Praeposition', base: '\u0644\u064E\u0640 (fuer)', ref: '2:22', explanation: 'Suffix \u0643\u064F\u0645\u0652 als Komplement. Fuer euch.' },
  { word: '\u0641\u0650\u064A\u0647\u064E\u0627', suffix: '\u0647\u064E\u0627', person: '3fs', function: 'Komplement der Praeposition', base: '\u0641\u0650\u064A (in)', ref: '2:25', explanation: 'Suffix \u0647\u064E\u0627 (ihr, fem.) als Komplement. In ihr/darin.' },
  { word: '\u0645\u0650\u0646\u0652\u0647\u064F', suffix: '\u0647\u064F', person: '3ms', function: 'Komplement der Praeposition', base: '\u0645\u0650\u0646\u0652 (von/aus)', ref: '2:60', explanation: 'Suffix \u0647\u064F (ihm) als Komplement. Von ihm / daraus.' },
  { word: '\u0625\u0650\u0644\u064E\u064A\u0652\u0643\u064E', suffix: '\u0643\u064E', person: '2ms', function: 'Komplement der Praeposition', base: '\u0625\u0650\u0644\u064E\u0649 (zu/hin)', ref: '2:4', explanation: 'Suffix \u0643\u064E (dir) als Komplement. Zu dir.' },
  { word: '\u0628\u0650\u0647\u0650\u0645\u0652', suffix: '\u0647\u0650\u0645\u0652', person: '3mp', function: 'Komplement der Praeposition', base: '\u0628\u0650\u0640 (mit/durch)', ref: '2:17', explanation: 'Suffix \u0647\u0650\u0645\u0652 als Komplement. Mit ihnen / durch sie.' },
  // Doppelsuffix
  ...
  { word: '\u0641\u064E\u0648\u0652\u0642\u064E\u0647\u064E\u0627', suffix: '\u0647\u064E\u0627', person: '3fs', function: 'Komplement der Praeposition', base: '\u0641\u064E\u0648\u0652\u0642\u064E (ueber)', ref: '2:26', explanation: 'Suffix \u0647\u064E\u0627 (ihr, fem.) als Komplement. Ueber ihr/darueber.' },
  ...
  { word: '\u0628\u064F\u064A\u064F\u0648\u062A\u0650\u0647\u0650\u0646\u0651\u064E', suffix: '\u0647\u0650\u0646\u0651\u064E', person: '3fp', function: 'Possessiv am Nomen', base: '\u0628\u064F\u064A\u064F\u0648\u062A (Haeuser)', ref: '33:33', explanation: 'Suffix \u0647\u0650\u0646\u0651\u064E (ihre, fem. Pl.) als Besitzer. Ihre Haeuser.' },
  ...
  { word: '\u0628\u064E\u064A\u0652\u0646\u064E\u0643\u064F\u0645\u0652', suffix: '\u0643\u064F\u0645\u0652', person: '2mp', function: 'Komplement der Praeposition', base: '\u0628\u064E\u064A\u0652\u0646\u064E (zwischen)', ref: '4:129', explanation: 'Suffix \u0643\u064F\u0645\u0652 als Komplement. Zwischen euch.' },
  { word: '\u0645\u0650\u0646\u0652\u0643\u064E', suffix: '\u0643\u064E', person: '2ms', function: 'Komplement der Praeposition', base: '\u0645\u0650\u0646\u0652 (von)', ref: '3:26', explanation: 'Suffix \u0643\u064E (dir) als Komplement. Von dir.' },
  ...
  { word: '\u0625\u0650\u0644\u064E\u064A\u0651\u064E', suffix: '\u064A\u064E', person: '1s', function: 'Komplement der Praeposition', base: '\u0625\u0650\u0644\u064E\u0649 (zu)', ref: '11:88', explanation: 'Suffix \u064A\u064E (mir) als Komplement. Zu mir.' },
  ...
  { word: '\u0639\u064E\u0644\u064E\u064A\u0652\u0646\u064E\u0627', suffix: '\u0646\u064E\u0627', person: '1p', function: 'Komplement der Praeposition', base: '\u0639\u064E\u0644\u064E\u0649 (auf)', ref: '7:89', explanation: 'Suffix \u0646\u064E\u0627 (uns) als Komplement. Auf uns.' },
  ...
  { word: '\u0641\u0650\u064A\u0647\u0650\u0645\u064E\u0627', suffix: '\u0647\u0650\u0645\u064E\u0627', person: '3md', function: 'Komplement der Praeposition', base: '\u0641\u0650\u064A (in)', ref: '55:68', explanation: 'Suffix \u0647\u0650\u0645\u064E\u0627 (ihnen beiden, Dual) als Komplement. In ihnen beiden.' },
  ...
  { word: '\u0639\u064E\u0644\u064E\u064A\u0652\u0647\u0650\u0645\u064E\u0627', suffix: '\u0647\u0650\u0645\u064E\u0627', person: '3md', function: 'Komplement der Praeposition', base: '\u0639\u064E\u0644\u064E\u0649 (auf)', ref: '20:121', explanation: 'Suffix \u0647\u0650\u0645\u064E\u0627 (ihnen beiden) als Komplement. Auf ihnen beiden.' },
  { word: '\u0642\u064E\u0627\u0644\u064E\u062A\u064E\u0627', suffix: '\u062A\u064E\u0627', person: '3md', function: 'Subjekt-Suffix + Objekt-Suffix', base: '\u0642\u064E\u0627\u0644\u064E (er sagte)', ref: '28:25', explanation: 'Endung \u062A\u064E\u0627 (Dual feminin) als Subjekt-Marker. Sie beide sagten.' },
  { word: '\u0623\u064E\u064A\u0652\u062F\u0650\u064A\u0647\u0650\u0645\u064E\u0627', suffix: '\u0647\u0650\u0645\u064E\u0627', person: '3md', function: 'Possessiv am Nomen', base: '\u0623\u064E\u064A\u0652\u062F\u0650\u064A (Haende, Dual)', ref: '5:38', explanation: 'Suffix \u0647\u0650\u0645\u064E\u0627 (ihrer beider) als Besitzer. Ihrer beider Haende.' },
]

const PERSONS = ['1s', '1p', '2ms', '2fs', '2mp', '2fp', '3ms', '3fs', '3md', '3mp', '3fp', '1p + 3ms', '1p + 3mp']
const FUNCTIONS = ['Objekt am Verb', 'Possessiv am Nomen', 'Komplement der Praeposition', 'Subjekt-Suffix + Objekt-Suffix']
  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginBottom: 20 }}>
        Erkenne das angehaengte Pronomen, bestimme Person/Genus/Numerus und die syntaktische Funktion.
      </p>
      ...
      <div style={{ background: 'var(--card-bg)', borderRadius: 12, padding: 24 }}>
        ...
        {!revealed && <button onClick={check} disabled={!answers.person || !answers.function} style={{ padding: '10px 28px', borderRadius: 8, border: 'none', background: answers.person && answers.function ? 'var(--accent-teal)' : 'var(--text-muted)', color: '#fff', cursor: answers.person && answers.function ? 'pointer' : 'default', width: '100%' }}>Pruefen</button>}
