...
function CaseRuleSheet() {
  return (
    <div>
      ...
      <table>
        <tbody>
          <tr><td><strong>Maf'ul bihi</strong></td><td>Direktes Objekt</td><td className="arabic" dir="rtl">كَتَبَ الكِتَابَ</td></tr>
          ...
          <tr><td><strong>Maf'ul mutlaq</strong></td><td>Absolutes Objekt</td><td className="arabic" dir="rtl">ضَرَبَ ضَرْبًا</td></tr>
