...
export default function ParadigmDrill({ onBack }) {
  ...
  function applyPassiveTransform(activeForm, tense, formId) {
    // Strip the active form to work with it character by character.
    // This is a best-effort mechanical transformation.
  ...
  function applyPerfectPassive(chars, formId) {
    ...
    if (formId === 'I') {
      // fa'ala -> fu'ila: first fatha->damma, second fatha->kasra
      ...
      // faa'ala -> fuu'ila: first fatha->damma, alif becomes waw conceptually
