...
const externalWords = externalWordsData
...
const INLINE_WORDS = [
  ...
  { word: '\u0627\u0644\u0652\u0645\u064F\u062A\u0651\u064E\u0642\u0650\u064A\u0646\u064E', root: '\u0648-\u0642-\u064A', prefixes: '\u0627\u0644\u0640 \u0645\u064F\u0640', pattern: '\u0645\u064F\u0641\u0652\u062A\u064E\u0639\u0650\u0644 (VIII)', suffixes: '\u064A\u0646\u064E', meaning: 'die sich Huetenden', ref: '2:2' },
  ...
  { word: '\u064A\u064F\u062E\u064E\u0627\u062F\u0650\u0639\u064F\u0648\u0646\u064E', root: '\u062E-\u062F-\u0639', prefixes: '\u064A\u064F\u0640', pattern: '\u064A\u064F\u0641\u064E\u0627\u0639\u0650\u0644\u064F (III)', suffixes: '\u0648\u0646\u064E', meaning: 'sie versuchen zu taeuschen', ref: '2:9' },
  ...
  return (
    <div style={{ maxWidth: 700, margin: '0 auto' }}>
      ...
      <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', marginBottom: 20 }}>
        Zerlege das Wort in seine Bestandteile: Praefix(e) + Wurzel + Muster + Suffix(e).
      </p>
      {score.total > 0 && (
          ...
          {['prefixes', 'root', 'pattern', 'suffixes'].map(field => (
            <div key={field}>
              <label style={{ fontSize: '0.8rem', color: 'var(--text-secondary)', display: 'block', marginBottom: 4 }}>
                {field === 'prefixes' ? 'Praefix(e)' : field === 'root' ? 'Wurzel' : field === 'pattern' ? 'Muster (Wazn)' : 'Suffix(e)'}
              </label>
              <input
                value={inputs[field]}
        ...
        {revealed && (
          <div style={{ marginTop: 16, padding: 16, background: 'var(--bg)', borderRadius: 8, border: '1px solid var(--border)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 8, fontSize: '0.9rem' }}>
              <div><span style={{ color: 'var(--text-muted)' }}>Praefix(e):</span> <span style={{ color: 'var(--accent-teal)', fontFamily: 'var(--font-arabic)' }}>{current.prefixes}</span></div>
