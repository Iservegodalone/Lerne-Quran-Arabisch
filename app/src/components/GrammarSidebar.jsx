...
const REKTION_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { arabic: 'صَارَ', translit: 'ṣāra', german: 'werden', quranRef: '2:65', quranArabic: 'كُونُوا قِرَدَةً' },
      ...
      { arabic: 'مَا زَالَ', translit: 'mā zāla', german: 'noch immer sein', quranRef: '12:85', quranArabic: 'تَاللَّهِ تَفْتَأُ تَذْكُرُ يُوسُفَ' },
  ...
  },
  {
    ...
    items: [
      ...
      { arabic: 'لِ', translit: 'li (Lam at-Taʿlīl)', german: 'um zu (Zweck)', quranRef: '12:35', quranArabic: 'بَدَا لَهُمْ لَيَسْجُنُنَّهُ' },
  ...
  },
  {
    ...
    items: [
      ...
      { arabic: 'لِ (الأمر)', translit: 'li (Amr)', german: 'soll/moege', quranRef: '65:7', quranArabic: 'لِيُنْفِقْ ذُو سَعَةٍ مِنْ سَعَتِهِ' },
  ...
  },
  {
    ...
    color: '#e91e63',
    items: [
      { arabic: 'لَا إِلٰهَ إِلَّا اللَّهُ', translit: 'lā ilāha illā llāhu', german: 'Kein Gott ausser Gott', quranRef: '47:19', quranArabic: 'فَاعْلَمْ أَنَّهُ لَا إِلٰهَ إِلَّا اللَّهُ' },
...
export default function GrammarSidebar({ visible, onClose }) {
