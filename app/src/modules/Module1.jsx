      ...
      content: (
        <>
          <p>
            ...
            geschlossen und wieder geoeffnet wird (wie das deutsche Knack-a in „Auge").
          </p>
          <p>
          ...
          <div className="m1-feature-grid" dir="rtl">
            <div className="m1-feature-box">
              ...
              <span className="m1-feature-info">
                Steht am Wortende. Sieht aus wie Ha' (ه) mit zwei Punkten darueber.
...
/* ────────────────────────────────────────────────────────
   Lesson 1.5: Getrennte Buchstaben (Huruf Muqatta'at)
   ──────────────────────────────────────────────────────── */
...
function TestAudioRecognition({ onBack }) {
  ...
  // Generiere 4 Antwortmoeglichkeiten (1 richtig + 3 falsch)
      ...
      <section className="m1-section">
        ...
        <div className="m1-card-grid">
          ...
          <button className="m1-card" onClick={() => setView(VIEWS.L15)}>
            ...
            <span className="m1-card__desc">
              Huruf Muqatta'at — 29 Suren mit Buchstaben deren Bedeutung nicht
              gesichert ist
            </span>
          </button>
        </div>
