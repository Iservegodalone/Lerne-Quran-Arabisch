...
function generateDisambiguationCards() {
  ...
  entries.forEach((entry) => {
    ...
    cards.push({
      ...
      backLabel: 'Alle gueltigen Lesungen',
      interval: 1,
      ease: 2.5,
      nextReview: null,
      history: [],
              ...
              {currentCard.isAmbiguous && currentCard.ambiguityOptions && currentCard.ambiguityOptions.length >= 2 && (
                ...
                >
                  <div style={{ fontSize: '0.75rem', color: '#a78bfa', marginBottom: '8px', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
                    Mehrdeutiges Wort — {currentCard.ambiguityOptions.length} gueltige Analysen
                  </div>
                ...
                >
                  ...
                  <div style={{ marginTop: '12px', textAlign: 'right' }}>
                    <button
                      onClick={(e) => {
                        e.stopPropagation()
                        if (window.confirm(`Karte "${card.front}" wirklich loeschen?`)) {
    ...
    <div style={{ maxWidth: '700px', margin: '0 auto' }}>
      ...
      >
        {[
          ...
          { label: 'Faellig', value: dueCount, color: '#ef4444' },
    ...
    <div style={{ maxWidth: '600px', margin: '0 auto' }}>
      ...
      >
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          >
            Taegliches Limit neuer Karten: {srsSettings.dailyNewLimit}
          </label>
          <input
            type="range"
            min="0"
        ...
        <div style={{ marginBottom: '24px' }}>
          ...
          >
            Taegliches Limit Wiederholungen: {srsSettings.dailyReviewLimit}
          </label>
          <input
            type="range"
            min="10"
        ...
        <div>
          ...
          >
            ...
            >
              ...
              <div style={{ fontSize: '0.8rem', color: 'var(--text-muted)' }}>Faellig</div>
            </div>
            <div
              style={{
                background: 'var(--bg-card)',
          ...
          {totalReviews > 0 && (
            ...
            >
              ...
              <p style={{ color: 'var(--text-secondary)', fontSize: '0.85rem', margin: 0 }}>
                {totalReviews} Wiederholungen insgesamt durchgefuehrt.{' '}
            ...
            >
              ...
              <div style={{ fontSize: '0.85rem', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
                ...
                <p style={{ marginBottom: '0' }}>
                  <strong>Bewertungen:</strong> Nochmal (vergessen) | Schwer (muehsam) | Gut (korrekt) | Leicht (sofort)
                </p>
              </div>
            </div>
          )}
