...
const PHASES = [
  ...
  { id: 4, name: 'Syntax und Partikeln', stufe: 'Stufe 3-4', desc: 'Satzstruktur, grammatische Rollen und die wichtigsten Funktionswoerter.' },
    ...
    <div className="m6-dashboard">
      ...
      <div className="m6-section">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '8px' }}>
          {[
            { phase: 1, label: 'Schrift & Buchstaben', modules: [{ id: 1, label: 'M1 — Buchstaben' }, { id: 8, label: 'M8 — Schreibuebung' }] },
      ...
      <div className="m6-section">
        ...
        <div className="m6-srs-grid">
          <div className="m6-srs-card" style={{ cursor: 'pointer' }} onClick={() => navigate('/module/8')}>
            ...
            <div className="m6-srs-label">Erster-Vers-Tutorial, Lane's-Anleitung, Rasm-Orthographie, Lesen, Diktat, Schreibuebung, Drucksheets</div>
          </div>
        </div>
      </div>
